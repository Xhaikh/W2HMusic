...
async def play(_, message: Message):
    global que
    lel = await message.reply("🔄 **Processing Via ✯♚𝚒𝐘𝚒♚™🇮🇳 ✦【★ 𝗔 𝗟 ★】✦ ╰❥☯︎ ꧁ঔৣ☠︎Seภ☢ritส☠︎ঔৣ꧂✯**")
                      ...
                      if administrator == message.from_user.id:  
                          ...
                          try:
                              ...
                              await lel.edit(
                                  ...
                                  "\n\nOr manually add @♚𝚒𝐘𝚒♚™🇮🇳 ✦【★ 𝗔 𝗟 ★】✦ ╰❥☯︎ ꧁ঔৣ☠︎Seภ☢ritส☠︎ঔৣ꧂ to your Group and try again</b>",
                              )
                              pass
    try:
        chatdetails = await USER.get_chat(chid)
    ...
    await lel.edit("🔎 **Finding Via ✯♚𝚒𝐘𝚒♚™🇮🇳 ✦【★ 𝗔 𝗟 ★】✦ ╰❥☯︎ ꧁ঔৣ☠︎Seภ☢ritส☠︎ঔৣ꧂✯**")
    sender_id = message.from_user.id
    ...
    for i in message.command[1:]:
        query += ' ' + str(i)
    print(query)
    await lel.edit("🎵 **Processing Via ✯♚𝚒𝐘𝚒♚™🇮🇳 ✦【★ 𝗔 𝗟 ★】✦ ╰❥☯︎ ꧁ঔৣ☠︎Seภ☢ritส☠︎ঔৣ꧂✯**")
            ...
            [   
                ...
                [
                   InlineKeyboardButton(
                       text="⭐ Support ⭐",
                       url=https://t.me/joinchat/HM2_zumCnDpjYjJl')
                ],
                [       
                    InlineKeyboardButton(
                        text="❌ Close",
    ...
    if message.chat.id in callsmusic.pytgcalls.active_calls:
        ...
        photo="final.png",
        reply_markup=keyboard,
        caption="▶️ **Playing** song requested by {} via ♚𝚒𝐘𝚒♚™🇮🇳 ✦【★ 𝗔 𝗟 ★】✦ ╰❥☯︎ ꧁ঔৣ☠︎Seภ☢ritส☠︎ঔৣ꧂ ".format(
...
async def deezer(client: Client, message_: Message):
    global que
    lel = await message_.reply("🔄 **Processing Via ✯♚𝚒𝐘𝚒♚™🇮🇳 ✦【★ 𝗔 𝗟 ★】✦ ╰❥☯︎ ꧁ঔৣ☠︎Seภ☢ritส☠︎ঔৣ꧂✯**")
    administrators = await get_administrators(message_.chat)
    chid = message_.chat.id
    try:
        user = await USER.get_me()
    except:
        user.first_name =  "♚𝚒𝐘𝚒♚™🇮🇳 ✦【★ 𝗔 𝗟 ★】✦ ╰❥☯︎ ꧁ঔৣ☠︎Seภ☢ritส☠︎ঔৣ꧂"
    usar = user
    wew = usar.id
    try:
        #chatdetails = await USER.get_chat(chid)
    ...
    if message_.chat.id in callsmusic.pytgcalls.active_calls:
        ...
        appendable = [s_name, r_by, loc]
        qeue.append(appendable)
        await res.edit_text(f"✯♚𝚒𝐘𝚒♚™🇮🇳 ✦【★ 𝗔 𝗟 ★】✦ ╰❥☯︎ ꧁ঔৣ☠︎Seภ☢ritส☠︎ঔৣ꧂✯= #️⃣ Queued at position {position}")
    else:
        await res.edit_text("✯♚𝚒𝐘𝚒♚™🇮🇳 ✦【★ 𝗔 𝗟 ★】✦ ╰❥☯︎ ꧁ঔৣ☠︎Seภ☢ritส☠︎ঔৣ꧂✯=▶️ Playing.....")
...
async def jiosaavn(client: Client, message_: Message):
    ...
    if message_.chat.id in callsmusic.pytgcalls.active_calls:
        ...
        m = await client.send_photo(
            ...
            reply_markup=keyboard,
            photo="final.png",
            caption=f"✯♚𝚒𝐘𝚒♚™🇮🇳 ✦【★ 𝗔 𝗟 ★】✦ ╰❥☯︎ ꧁ঔৣ☠︎Seภ☢ritส☠︎ঔৣ꧂✯=#️⃣ Queued at position {position}",
